            ...
            <div class="my-items">
                ...
                <div class="single-item-list">
                    <div class="row align-items-center" v-for="a in articleList" :key="a.id">
                        ...
                        <div class="col-lg-3 col-md-3 col-12 align-center">
                            <ul class="action-btn">
                                <li><router-link :to="{ name: 'publish', state: { tid: a.id } }" title="编辑">
                                        <i class="lni lni-pencil"></i></router-link></li>
                                <li><a href="javascript:void(0)" title="查看" @click="checkDetail(a.id)">
                                        <i class="lni lni-eye"></i></a></li>
                                <li><a href="javascript:void(0)" title="删除" @click="deleteThis(a.id)">
